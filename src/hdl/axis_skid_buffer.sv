...
module axis_skid_buffer #(
    ...
    assign M_AXIS_TVALID = skid_tvalid_q ? skid_tvalid_q : S_AXIS_TVALID;
    assign M_AXIS_TDATA  = skid_tvalid_q ? skid_tdata_q  : S_AXIS_TDATA;
    assign M_AXIS_TLAST  = skid_tvalid_q ? skid_tlast_q  : S_AXIS_TLAST;
