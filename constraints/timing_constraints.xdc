...
set_input_delay -clock [get_clocks CLK_CORE_clk_wiz_0] -max 1.600 [get_ports {S_AXIS_TVALID S_AXIS_TDATA[*] S_AXIS_TLAST S_AXIS_TKEEP[*]}]
set_input_delay -clock [get_clocks CLK_CORE_clk_wiz_0] -min 0.400 [get_ports {S_AXIS_TVALID S_AXIS_TDATA[*] S_AXIS_TLAST S_AXIS_TKEEP[*]}]

set_input_delay -clock CLK_CORE_clk_wiz_0 -max 2.000 [get_ports {S_PAYLOAD_LEN[*]}]
set_input_delay -clock CLK_CORE_clk_wiz_0 -min 0.500 [get_ports {S_PAYLOAD_LEN[*]}]
...
set_output_delay -clock CLK_CORE_clk_wiz_0 -max 1.600 [get_ports S_AXIS_TREADY]
set_output_delay -clock CLK_CORE_clk_wiz_0 -min 0.200 [get_ports S_AXIS_TREADY]

# Apply constraints to the downstream backpressure input (Master Ready)
# set_input_delay -clock CLK_IO_clk_wiz_0 -max 1.600 [get_ports M_AXIS_TREADY]
# set_input_delay -clock CLK_IO_clk_wiz_0 -min 0.400 [get_ports M_AXIS_TREADY]
...
set_output_delay -clock [get_clocks CLK_IO_clk_wiz_0] -max 2.000 [get_ports {M_AXIS_TVALID M_AXIS_TDATA[*] M_AXIS_TLAST M_AXIS_TKEEP[*]}]
set_output_delay -clock [get_clocks CLK_IO_clk_wiz_0] -min -1.000 [get_ports {M_AXIS_TVALID M_AXIS_TDATA[*] M_AXIS_TLAST M_AXIS_TKEEP[*]}]


set_input_delay -clock [get_clocks CLK_IO_clk_wiz_0] -max 1.200 [get_ports M_AXIS_TREADY]
set_input_delay -clock [get_clocks CLK_IO_clk_wiz_0] -min 0.000 [get_ports M_AXIS_TREADY]
